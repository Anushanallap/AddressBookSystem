...
public class AddressSorting {
    ...
    AddressSearch addressBookService = new AddressSearch();
    ...
    public void searchByCity() {
        ...
        for (AddressBooklist addressBookList : addressBookService.AddressBooklist) {
            for (AddressBookContact contact : addressBookList.AddressbookcontactDetails) {
